...
if __name__ == "__main__":
    ...
    dest_dir = os.path.join('alphanumeric', 'datasets','processed', os.path.dirname(base_dir))
    ...
    for i in range(len(img_paths)):
        ...
        if file_ext in ['.png', '.jpg']:
            ...
            alphanum_output_path = os.path.join(dest_dir, f"{base_name}_alphanum{file_ext}" )
            print(alphanum_output_path)
            cv.imwrite(alphanum_output_path, alphanum_mask)